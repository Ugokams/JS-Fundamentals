...
This repository contains basic JavaScript exercises focused on understanding fundamental programming concepts, such as variables, loops, conditionals, functions, and handling command-line arguments in Node.js.

Each script demonstrates a specific concept and can be executed using the Node.js runtime.
...
All your files will be interpreted on Ubuntu 20.04 LTS using Node.js.
...
git clone https://github.com/Ugokams/JS-Fundamentals.git
cd JS-Fundamentals
